...
**Not a permission category.** Every layer is a local file the user put there, and promotion is a REST action they initiated — the same reasoning that leaves *saving* a connection ungated. Milestone 6's fetch is what will need `network`.
