...
def create_prompt(
    ...
    if previous_code:
        previous_code_context = f"\n<previous_visualization_code>\n{previous_code}\n</previous_visualization_code>\n\n<customization_instruction>\nThe user wants to customize or refine the visualization generated by the previous code block above. Retain the data manipulation logic, but modify the visual parameters (e.g. colors, layout size, labels, legends) according to the user request.\n</customization_instruction>\n"
...
{context}
{plan_context}{error_context}{previous_code_context}
<user_request>
{instruction}
</user_request>
...
def create_planning_prompt(
    ...
    previous_code_context = ""
    if previous_code:
        previous_code_context = f"\n<previous_visualization_code>\n{previous_code}\n</previous_visualization_code>\n\n<customization_instruction>\nThe user wants to customize or refine the visualization generated by the previous code block above. Focus your plan on modifying only the visual formatting/aesthetic parameters (e.g. colors, grid style, legends, layout labels) from the previous code.\n</customization_instruction>\n"
