...
def test_upload_and_chat_flow(mock_agent_run, sample_csv):
    ...
    with patch("src.core.agent.flow.ScientificAgent.run") as mock_run:
        ...
        chat_payload = {"message": "show the profit generated by house owner in the month of may using plot"}
...
def test_chat_without_upload():
    ...
    assert response.json()["detail"] == [{"loc": ["state"], "msg": "No dataset loaded.", "type": "state_error"}]
